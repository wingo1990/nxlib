 ...
 */
struct htable_st;
typedef struct htable_st htable_st;
 ...
 * \param vlaue 值
 */
void hash_insert(htable_st *htable, void *key, int klen, void *vlaue);
